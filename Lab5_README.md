...
Extract text from images using Tesseract and EasyOCR with OpenCV
preprocessing.
...
## Results Table
  ...
  -------------- -------- ------- ------
  receipt1.jpg   245      389     +144
  receipt2.jpg   312      456     +144
  receipt3.jpg   278      412     +134
  receipt4.jpg   298      435     +137
  receipt5.jpg   334      478     +144
...
Lab5-OCR/ ├── lab5_ocr.py ├── requirements.txt ├──
receipt_ocr_results.csv ├── receipts/ └── README.md
...
OCR accuracy improves significantly with preprocessing. Adaptive
thresholding best for varied lighting conditions.
